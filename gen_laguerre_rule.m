function [x,w] = gen_laguerre_rule ( order, alpha, a, b )

% Modified GEN_LAGUERRE_RULE to not multiply by gamma(alpha+1) (weights blow up)
...
%    5, Generalized Laguerre, (a,inf)     1/gamma(alpha+1)*(x-a)^alpha*exp(-b*(x-a))
...
%    3, Gegenbauer,           (a,b)       ((b-x)*(x-a))^alpha
%    4, Jacobi,               (a,b)       (b-x)^alpha*(x-a)^beta
%    5, Generalized Laguerre, (a,+oo)     1/gamma(alpha+1)*(x-a)^alpha*exp(-b*(x-a))
